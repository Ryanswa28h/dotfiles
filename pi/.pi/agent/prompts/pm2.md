...
4. Generate command files in `.pi/commands/`
5. Generate script files in `.pi/scripts/`
...
**Pi Commands:** /pm2-all, /pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /pm2-logs, /pm2-status
