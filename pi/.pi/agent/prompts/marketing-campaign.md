...
When saving campaign assets, the convention is `.pi/campaigns/{campaign-name}/`:

```
.pi/campaigns/product-launch/
├── positioning.md
├── landing-page.md
├── email-sequence.md
├── social-posts.md
...
```
/marketing-campaign review .pi/campaigns/the-key/landing-page.md
```
...
*Part of [Everything Pi](https://github.com/affaan-m/pi)*
