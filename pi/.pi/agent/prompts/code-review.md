...
2. **Planning artifacts** — Check for context
...
Create review artifact at `.pi/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.pi/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .pi/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
