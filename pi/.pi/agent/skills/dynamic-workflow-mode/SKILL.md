...
description: "Design task-local harnesses, eval gates, and reusable skill extraction for Pi dynamic workflow mode and other adaptive agent harnesses."
metadata:
  origin: ECC
---
...
- The user mentions dynamic workflows, custom harnesses, harness-per-task, adaptive workflows, or Pi dynamic workflow mode.
