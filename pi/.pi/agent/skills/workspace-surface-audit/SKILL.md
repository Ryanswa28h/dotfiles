...
description: Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up Pi or understanding what capabilities are actually available in their environment.
metadata:
  origin: ECC
---
...
- User says "set up Pi", "recommend automations", "what plugins or MCPs should I use?", or "what am I missing?"
...
1. Repo surface
   ...
   - `.mcp.json`, `.lsp.json`, `.pi/settings*.json`, `.codex/*`
...
- official Pi plugins that overlap with setup, review, docs, design, or workflow quality
- locally installed plugins in Pi or Codex
