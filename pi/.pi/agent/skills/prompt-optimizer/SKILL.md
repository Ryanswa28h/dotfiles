...
- User says "what's the best way to ask Pi to..."
...
1. Check if a `AGENTS.md` exists in the working directory — read it for project conventions
...
- "Rewrite this prompt so Pi uses the right commands"
- "帮我优化这个指令"
