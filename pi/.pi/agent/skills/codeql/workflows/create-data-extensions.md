...
1. Check for existing data extensions
2. Query known sources and sinks (blocked by Step 1)
3. Identify missing sources and sinks (blocked by Step 2)
4. Create data extension files (blocked by Step 3)
5. Validate with re-analysis (blocked by Step 4)
...
- "Create all" — Generate extensions for all identified gaps
- "Select individually" — Choose which gaps to model
- "Skip" — No extensions needed, proceed to analysis
