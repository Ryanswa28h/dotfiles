...
description: Analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, and a starter AGENTS.md. Use when joining a new project or setting up Pi for the first time in a repo.
metadata:
  origin: ECC
---
...
Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up Pi in an existing repo for the first time.

## When to Use

- First time opening a project with Pi
...
Generate or update a project-specific AGENTS.md based on detected conventions. If `AGENTS.md` already exists, read it first and enhance it — preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing AGENTS.md** — if one already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating a AGENTS.md that's longer than 100 lines — keep it focused
...
**User**: "Generate a AGENTS.md for this project"
