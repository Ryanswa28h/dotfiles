...
| Skills directory | `ls /home/ryan/.pi/agent/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
2. Is there an MCP for this? → Check `/home/ryan/.pi/agent/settings.json` and search
3. Is there a skill for this? → Check `/home/ryan/.pi/agent/skills/`
...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, Pi skills, GitHub
  Return: Structured comparison with recommendation
")
```

Older Pi docs may call this `Task(...)`; use the current agent/subagent
