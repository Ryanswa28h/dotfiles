...
### Layer 2: Pi Memory (Quick Access)
- **Path:** `~/.pi/projects/*/memory/`
...
- Always update Pi memory for quick access
...
- Sources: Pi session files, Codex sessions, other agent sessions
...
Write to ~/.pi/projects/*/memory/ for cross-session recall
