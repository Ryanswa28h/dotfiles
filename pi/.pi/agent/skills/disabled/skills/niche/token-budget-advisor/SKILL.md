...
Intercept the response flow to offer the user a choice about response depth **before** Pi answers.
...
Standalone skill from [TBA — Token Budget Advisor for Pi](https://github.com/Xabilimon1/Token-Budget-Advisor-Claude-Code-).
