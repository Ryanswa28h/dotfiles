---
name: eval-harness
description: Formal evaluation framework for Pi sessions implementing eval-driven development (EDD) principles
metadata:
  origin: ECC
...
A formal evaluation framework for Pi sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for Pi task completion
...
### Capability Evals
Test if Pi can do something it couldn't before:
```markdown
[CAPABILITY EVAL: feature-name]
Task: Description of what Pi should accomplish
Success Criteria:
  - [ ] Criterion 1
  - [ ] Criterion 2
  - [ ] Criterion 3
...
Use Pi to evaluate open-ended outputs:
```markdown
[MODEL GRADER PROMPT]
