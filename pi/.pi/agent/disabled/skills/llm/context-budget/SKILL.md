---
name: context-budget
description: Audits Pi context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations.
metadata:
  origin: ECC
---
...
Analyze token overhead across every loaded component in a Pi session and surface actionable optimizations to reclaim context space.
