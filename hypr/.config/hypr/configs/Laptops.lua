...
--hl.bind("switch:off:Lid Switch", hl.dsp.exec_cmd("echo \"monitor = eDP-1, preferred, auto, 1\" > " .. configsDir .. "/LaptopDisplay.lua"), { locked = true })
--hl.bind("switch:on:Lid Switch", hl.dsp.exec_cmd("echo \"monitor = eDP-1, disable\" > " .. configsDir .. "/LaptopDisplay.lua"), { locked = true })

-- for laptop-lid action (to erase the last entry)
--hl.on("hyprland.start", function()
--    hl.exec_cmd("echo \"monitor = eDP-1, preferred, auto, 1\" > " .. home .. "/.config/hypr/configs/LaptopDisplay.lua")
--end)
