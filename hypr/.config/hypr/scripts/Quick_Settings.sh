...
main() {
    ...
    case "$choice" in
    "view/edit User Defaults") file="$configs/Defaults.lua" ;;
    "view/edit ENV variables") file="$configs/EnvVariables.lua" ;;
    "view/edit Window Rules") file="$configs/WindowRules.lua" ;;
    "view/edit User Keybinds") file="$configs/Keybinds.lua" ;;
    "view/edit User Settings") file="$configs/Settings.lua" ;;
    "view/edit Startup Apps") file="$configs/StartupApps.lua" ;;
    "view/edit Decorations") file="$configs/Decorations.lua" ;;
    "view/edit Animations") file="$configs/Animations.lua" ;;
    "view/edit Laptop Keybinds") file="$configs/Laptops.lua" ;;
